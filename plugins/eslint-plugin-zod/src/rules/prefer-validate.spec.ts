  ...
  invalid: [
    {
      ...
      code: "import * as z from 'zod'; const schema = z.string(); ((schema).safeParse(data))[(('success'))];",
      output: null,
      errors: [
        {
    ...
    },
    {
      ...
      code: "import * as z from 'zod'; const schema = z.string(); const r = schema.safeParse(data); ((r))[(('success'))];",
      output: null,
      errors: [
        {
          messageId: 'preferValidate',
